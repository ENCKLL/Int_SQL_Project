...
- Analyzied customer retention at a cohort level
...
<img src="images/2_cohort_analysis_.png"
width="50%">
...
alt ="Customer Churn by Cohort Year" style= "width:50%;
height: auto;">

📊 **Key Findings:** 
- Cohort churn stabilizes at 90% after 2-3 years, indicating predictable long term retention pattern
- Retention rates are consistently low (8-10%) across all cohorots, suggesting retention issues are systemic rather than specific to certain years.
...
- Implement loyality/subscription programs to stablize revenue fluctuations
- Apply successful startegies from high-spending 2016-2018 cohorts to newer customers

3. **Retention & Churn Prevention** (Customer Retention)
- Strengthen first 1-2 year engagemnet with onboarding incentives and loyalty rewards
